...
- xref:api:utils.adoc#EnumerableSetViewFriendly[`EnumerableSetViewFriendly`]: A https://en.wikipedia.org/wiki/Set_(abstract_data_type)[set] with enumeration capabilities.
